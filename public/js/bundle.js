      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'You have Logged out');
              setTimeout(function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            res = _context.sent;
            if (res.data.status === 'success') (0, _alert.showAlert)('success', "Your ".concat(type.toUpperCase(), " has been updated"));
            setTimeout(function () {
              location.reload(true);
            }, 0);
            _context.next = 12;
...
var stripe = Stripe('pk_test_51LBXAjCUmCfd0vF7SOGijh8AmaLes0EXfxugbEPLVDRXoyIBjyybCR0FVYKl2UVe3yNc3kPKk3ELCO1xqUvjAYeI00dLNTuwnX');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://localhost:3000/api/v1/booking/checkout-session/".concat(id));
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              currentPassword = passwordForm.querySelector('#password-current').value;
              newPassword = passwordForm.querySelector('#password').value;
              confirmNewPassword = passwordForm.querySelector('#password-confirm').value;
              _context.next = 6;
